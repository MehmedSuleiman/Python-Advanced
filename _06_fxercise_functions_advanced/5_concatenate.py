...
#First, you should concatenate all arguments successively. Next, take each key successively, and if
# it is present in the resulting string, change all matching parts with the key's value.
