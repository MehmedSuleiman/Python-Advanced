...
# Otherwise, you should move the cup of milk at the end of the sequence and decrease the value of the
# chocolate by 5 without moving it from its position.
...
#When you successfully prepare 5 chocolate milkshakes, or you have no more chocolate or cups of milk left, you
# need to stop making chocolate milkshakes.
#Input
